...
INSERT INTO "new_Shop" ("currencyCode", "id", "installedAt", "lastMetaSync", "lastOrderSync", "matchingTolerance", "metaAccessToken", "metaAccountTimezone", "metaAdAccountId", "metaAttributionWindow", "metaCurrency", "onboardingCompleted", "revenueDefinition", "shopDomain", "shopifyCurrency", "shopifyTimezone", "utmAdsFixed", "utmAdsMissing", "utmAdsTotal", "utmAdsWithTags", "utmLastAudit", "utmTemplate", "webhooksFirstFiredAt", "webhooksRegisteredAt") SELECT "currencyCode", "id", "installedAt", "lastMetaSync", "lastOrderSync", "matchingTolerance", "metaAccessToken", "metaAccountTimezone", "metaAdAccountId", "metaAttributionWindow", "metaCurrency", "onboardingCompleted", "revenueDefinition", "shopDomain", "shopifyCurrency", "shopifyTimezone", "utmAdsFixed", "utmAdsMissing", "utmAdsTotal", "utmAdsWithTags", "utmLastAudit", "utmTemplate", "webhooksFirstFiredAt", "webhooksRegisteredAt" FROM "Shop";
DROP TABLE "Shop";
