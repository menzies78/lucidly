...
INSERT INTO "new_Order" ("attributionConfidence", "attributionLayer", "channelName", "createdAt", "currency", "financialStatus", "frozenSubtotalPrice", "frozenTotalPrice", "id", "importedAt", "isNewCustomerOrder", "isOnlineStore", "metaAdId", "metaAdName", "metaAdSetId", "metaAdSetName", "metaCampaignId", "metaCampaignName", "orderNumber", "pixelJourney", "shopDomain", "shopifyCustomerId", "shopifyOrderId", "subtotalPrice", "totalPrice") SELECT "attributionConfidence", "attributionLayer", "channelName", "createdAt", "currency", "financialStatus", "frozenSubtotalPrice", "frozenTotalPrice", "id", "importedAt", "isNewCustomerOrder", "isOnlineStore", "metaAdId", "metaAdName", "metaAdSetId", "metaAdSetName", "metaCampaignId", "metaCampaignName", "orderNumber", "pixelJourney", "shopDomain", "shopifyCustomerId", "shopifyOrderId", "subtotalPrice", "totalPrice" FROM "Order";
DROP TABLE "Order";
