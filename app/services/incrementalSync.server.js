  ...
  for (const order of utmOrders) {
    ...
    await db.attribution.upsert({
      ...
      create: {
        ...
        isNewCustomer: order.isNewCustomerOrder === true || order.customerOrderCountAtPurchase === 1, isNewToMeta: order.isNewCustomerOrder === true || order.customerOrderCountAtPurchase === 1,
        matchMethod: "utm",
